 ...
 *
 * $Id: hybdefs.h,v 1.4 2001/05/16 12:35:01 kreator Exp $
 */
...
#define   IPLEN       128 /* ip length */
#define   CHANNELLEN  30 /* channel length */
...
#define LVL_EXPERIMENTAL 4 /* is able to execute experimental commands */
#define LVL_USERADMIN    5 /* is able to administrate users (right now,
                             cloaking and possibly some of the more sensitive
                             commands, like omode, trace, etc.) */
