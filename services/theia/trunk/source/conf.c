 ...
 *
 * $Id: conf.c,v 1.3 2001/11/12 09:50:55 asuffield Exp $
 */
...

{
  ...
  {
    fprintf (stderr,
      "No users (O:) specified for access to services in %s (at least one user should be added), exiting\n",
      ConfigFile);
    ConfError = 1;
    /* Hack. Don't fail loudly in this case, because it just hasn't been configured yet */
    exit(0);
  }
