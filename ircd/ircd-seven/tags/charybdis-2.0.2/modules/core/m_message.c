 ...
 *  USA
 *
 *  $Id: m_message.c 1591 2006-06-04 01:21:30Z nenolod $
 */
...
DECLARE_MODULE_AV1(message, modinit, moddeinit, message_clist, NULL, NULL, "$Revision: 1591 $");
	...
	if((result = can_send(chptr, source_p, NULL)))
	{
		   ...
		   !flood_attack_channel(p_or_n, source_p, chptr, chptr->chname))
		{
			sendto_channel_flags(client_p, ALL_MEMBERS, source_p, chptr,
					     "%s %s :%s", command, chptr->chname, text2);
		}
	}
