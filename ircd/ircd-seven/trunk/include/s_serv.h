...
#define CAP_ZIP         0x00080	/* Can do ZIPlinks */
#define CAP_KNOCK	0x00100	/* supports KNOCK */
#define CAP_TB		0x00200	/* supports TBURST */
#define CAP_UNKLN       0x00400	/* supports remote unkline */
#define CAP_CLUSTER     0x01000	/* supports cluster stuff */
#define CAP_ENCAP	0x02000	/* supports ENCAP */
#define CAP_TS6		0x04000 /* supports TS6 or above */
#define CAP_SERVICE	0x08000
#define CAP_RSFNC	0x10000 /* rserv FNC */

#define CAP_MASK        (CAP_QS  | CAP_EX   | CAP_CHW  | \
                         CAP_IE  | CAP_KLN  | CAP_SERVICE |\
                         CAP_CLUSTER | CAP_ENCAP | CAP_ZIP |\
                         CAP_KNOCK  | CAP_UNKLN | \
			 CAP_RSFNC)
