...
#define MODE_EXLIMIT    0x0080

#define CHFL_BAN        0x01000000	/* ban channel flag */
#define CHFL_EXCEPTION  0x02000000	/* exception to ban channel flag */
#define CHFL_INVEX      0x04000000
