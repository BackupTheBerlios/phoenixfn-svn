...
#define CONF_DLINE             0x10000
#define CONF_EXEMPTDLINE       0x20000
...
#define CONF_FLAGS_EXEMPTRESV		0x00001000	/* exempt from resvs */
#define CONF_FLAGS_EXEMPTFLOOD          0x00002000
#define CONF_FLAGS_EXEMPTSPAMBOT	0x00004000
#define CONF_FLAGS_EXEMPTSHIDE		0x00008000
#define CONF_FLAGS_EXEMPTJUPE		0x00010000	/* exempt from resv generating warnings */
/* server flags */
